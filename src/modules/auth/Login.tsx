  ...
  return (
    <div className={styles['container']}>
      ...
      <div className={styles['content']}>
        <BaseFlex vertical gap='spacing-32px' padding={{x: 'spacing-48px', y: 'spacing-48px'}}  className={styles['content__form']}>
          ...
          <BaseFlex vertical gap='spacing-24px'>
            <BaseFlex vertical gap='spacing-8px'>
              <BaseButton  
                ...
                href='#' 
                icon={
                  <Image src={'/icons/sns/kakaotalk.svg'} width={24} height={24} alt='' />
                } 
                iconPosition='start' 
              ...
              <BaseButton  
                ...
                href='#' 
                icon={
                  <Image src={'/icons/sns/facebook.svg'} width={24} height={24} alt='' />
                } 
                iconPosition='start' 
              ...
              <BaseButton  
                ...
                href='#' 
                icon={
                  <Image src={'/icons/sns/google.svg'} width={24} height={24} alt='' />
                } 
                iconPosition='start' 
              ...
              <BaseButton  
                ...
                href='#' 
                icon={
                  <Image src={'/icons/sns/apple.svg'} width={24} height={24} alt='' />
                } 
                iconPosition='start' 
