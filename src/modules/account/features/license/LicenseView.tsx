...
참고: 당사는 단독 재량으로 언제든지 본 이용 약관을 변경, 수정 또는 기타 방식으로 변경할 권리를 보유합니다. 달리 명시되지 않는 한, 수정 사항은 즉시 효력을 발생합니다. 본 이용 약관을 정기적으로 검토하시기 바랍니다. 변경 및/또는 수정 사항이 게시된 After도 본 사이트를 계속 사용하는 경우, 귀하는 개정된 이용 약관 및 변경 사항 고지 기준의 합당성에 동의하는 것으로 간주됩니다. 참고로, 본 페이지는 본 이용 약관 상단에 표시된 날짜를 기준으로 최종 업데이트되었습니다.
2. 개인정보 보호
...
B. 귀하는 과실을 포함하되 이에 국한되지 않는 어떠한 상황에서도 당사 사이트, 자료 또는 해당 사이트의 기능의 사용 또는 사용 불능으로 인해 발생하는 직접적, 간접적, 우발적, 특별, 징벌적 또는 결과적 손해에 대해 당사가 책임을 지지 않는다는 점을 이해하고 동의합니다. 이는 당사가 그러한 손해의 가능성을 사Before 통보받았더라도 마찬가지입니다. 상기 제한 사항은 제한적 구제 수단의 본질적인 목적 달성 실패에도 불구하고 적용됩니다.
