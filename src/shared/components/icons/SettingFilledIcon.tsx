...
export const SettingFilledIcon: React.FC<IconProps> = ({ width = 24, height = 24, ...props }) => {
  return (
    <svg width={width} height={height} {...props} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        ...
        fill="#49C3D0"
      />
      <path opacity="0.4" d="M6 20H12V4H6C3.79 4 2 5.79 2 8V16C2 18.21 3.79 20 6 20Z" fill="#49C3D0" />
      <path opacity="0.4" d="M18 20H15V4H18C20.21 4 22 5.79 22 8V16C22 18.21 20.21 20 18 20Z" fill="#49C3D0" />
      <path
