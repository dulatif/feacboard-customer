...
export const ColorIcon: React.FC<IconProps> = ({ width = 24, height = 24, ...props }) => {
  return (
    <svg width={width} height={height} {...props} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      />
      <path
        d="M15.5984 9.6C15.5984 10.07 15.5084 10.52 15.3484 10.93C14.9384 11.97 14.0484 12.78 12.9484 13.08C12.6484 13.16 12.3284 13.21 11.9984 13.21C11.6684 13.21 11.3484 13.17 11.0484 13.08C9.9484 12.78 9.05844 11.98 8.64844 10.93C8.48844 10.52 8.39844 10.07 8.39844 9.6C8.39844 7.61 10.0084 6 11.9984 6C13.9884 6 15.5984 7.61 15.5984 9.6Z"
        stroke="white"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
