...
export const ChatIcon: React.FC<IconProps> = ({ width = 24, height = 24, ...props }) => {
  return (
    <svg width={width} height={height} {...props} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path
        ...
        strokeLinejoin="round"
      />
      <path d="M9.9955 13.25H10.0045" stroke="#49C3D0" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M6.4955 13.25H6.5045" stroke="#49C3D0" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  )
}
