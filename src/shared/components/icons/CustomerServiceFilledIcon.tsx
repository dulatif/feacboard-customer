...
export const CustomerServiceFilledIcon: React.FC<IconProps> = ({ width = 24, height = 24, ...props }) => {
  return (
    <svg width={width} height={height} {...props} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      />
      <path
        d="M14.6792 15.0598C15.4892 15.0598 15.9592 14.1598 15.5092 13.4898C14.8292 12.4798 13.5092 11.7998 11.9992 11.7998C10.4892 11.7998 9.16918 12.4798 8.48918 13.4898C8.03918 14.1598 8.5092 15.0598 9.3192 15.0598H14.6792Z"
        fill="#49C3D0"
      />
    </svg>
  )
