  ...
  designer: [
    {
      ...
      portfolio: [
        [
          '/dummy/designer-portfolio05.jpg',
          '/dummy/designer-portfolio06.jpg',
          '/dummy/designer-portfolio07.jpg',
          '/dummy/designer-portfolio08.jpg',
          '/dummy/designer-portfolio09.jpg',
          '/dummy/designer-portfolio10.jpg',
        ],
        [
          '/dummy/designer-portfolio05.jpg',
          '/dummy/designer-portfolio06.jpg',
      ...
      career: [
        ...
        },
        {
          ...
          in: '',
          out: '',
          description: `헤어&메이크업 21년 경력으로 고객의 고유의 무드를 감각적으로 해석하여 디자인하여 수많은 아티스트들이 인정하는 김선정 원장입니다
...
헤어는 단순한 기술이 아니라 당신만의 이미지를 완성하는 퍼스널 디자인 작업이라고 생각합니다 제가 해드리는 스타일은 고객님의 추구하는 분위기와 에너지를 드러내는것이라고 믿어요. 지금까지 다져온 탄탄한 경험을 당신의 일상에 자연스럽게 녹여드립니다. 당신의 일상도 충분히 특별해 질수 있어요! 믿고 찾아주신 마음에 보답하며 늘 초심으로 겸손하게 최선을 다해 작업해드릴게요!`,
    ...
    },
    {
      ...
      bio: '안녕하세요J 글래드 헤어 강남점에서 근무하고 있는 한별 팀장 이라고 합니다!',
  ...
  shop: [
    {
      ...
      reviews: [
        ...
        },
        {
          ...
          images: ['/dummy/before03.jpg', '/dummy/after04.jpg'],
          videoThumbnails: [],
        },
        {
          date: '2024.12.16',
